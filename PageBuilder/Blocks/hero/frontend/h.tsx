  ...
  return (
    ...
    >
      {isFull && (
        <div>
          <SanityImage
            src={mainImage}
            fill
            className="mx-auto w-full max-w-[1800px] border-2 border-red object-cover"
          />
          <div
      ...
      <div className="order-2 flex w-full items-center break-words md:order-1 ">
        <div
          className={clsx("border-2 border-red", {
            "mx-auto w-full max-w-screen-lg px-2": isFull,
          })}
        >
          {content ? (
      ...
      {isHalf && (
        <div className=" relative order-1 my-8 min-h-[250px] border-2 border-blue-500 object-cover md:order-2 md:my-0">
