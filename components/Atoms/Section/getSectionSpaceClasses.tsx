...
export interface IUseSectionWidthProps extends BlockSpace {
  defaultSpace?: BlockSpace["topSpace"];
}

const getSectionSpaceClasses = (props: IUseSectionWidthProps) => {
...
export default getSectionSpaceClasses;
