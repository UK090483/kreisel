    ...
    <div className="relative ">
      ...
      >
        <svg
          ...
          className={clsx("h-8 w-[300vw] fill-current md:w-[150vw] lg:w-full", {
            "text-white": color === "white",
            "text-primary": color === "primary",
            "text-primary-light": color === "primary-light",
            "text-primary-xLight": color === "primary-xLight",
            "text-secondary": color === "secondary",
            "text-secondary-light": color === "secondary-light",
            "text-grey": color === "grey",
            "text-grey-light": color === "grey-light",
            "drop-shadow-[0_-3px_3px_rgba(0,0,0,0.15)]": pos === "top",
            "drop-shadow-[0_3px_3px_rgba(0,0,0,0.15)]": pos === "bottom",
          })}
        >
